...
const getPastLaunches = async () => {
  ...
  try {
    ...
    // const filter = document.querySelector('.yearFilter')
    // filter.addEventListener('change', (event) => {
    //   const targetingYear = event.target.value;
    //   pastLaunchResults.filter(year => {
    //    return year.launch_year === `"${targetingYear}"`;
    //   })
    //   createPastLaunchesHtml(pastLaunchResults);
    // })  
...
const createPastLaunchesHtml = (pastLaunchResults) => {
  ...
  //  const yearSort = pastLaunchResults.filter(year => {
  //     const thisYear = "2020";
  ...
  //   console.log(yearSort);
    ...
    filter.addEventListener('change', (event) => {
      const targetingYear = event.target.value;
      console.log(targetingYear);
      const filtered = pastLaunchResults.filter(year => year.launch_year === targetingYear)

      console.log(filtered);

      filtered.map(pastLaunch => {
